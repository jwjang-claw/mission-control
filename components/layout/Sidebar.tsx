  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 px-4 overflow-y-auto py-1">
          ...
          {navItems.map((item) => {
            ...
            return (
              <li key={item.href} className="list-none">
                {isDisabled ? (
                  <span className="flex items-center gap-3 px-3 py-2 rounded-lg text-[13px] text-[var(--color-text-tertiary)] cursor-not-allowed opacity-40">
        ...
        <div className="mt-8">
          ...
          <ul className="space-y-1 text-[13px] text-[var(--color-text-secondary)]">
            <li className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[var(--color-bg-hover)] cursor-pointer transition-colors">
              <span className="w-5 text-center text-xs leading-none">⭐</span>
              <span>Project Alpha</span>
            </li>
            <li className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[var(--color-bg-hover)] cursor-pointer transition-colors opacity-40">
              <span className="w-5 text-center text-xs leading-none">⭐</span>
      ...
      <div className="px-4 py-4 border-t border-[var(--color-border-subtle)]">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[var(--color-bg-hover)] cursor-pointer transition-colors">
